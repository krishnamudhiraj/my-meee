          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Object(__WEBPACK_IMPORTED_MODULE_2__services_admins__["a" /* authCheck */])(auth);
...
var authCheck = function authCheck(auth) {
  return new Promise(function (resolve, reject) {
    ...
    __WEBPACK_IMPORTED_MODULE_1_firebase_app___default.a.auth().signInAndRetrieveDataWithEmailAndPassword(auth.email, auth.password).then(function (data) {
      console.log('###################', data);
...
//# sourceMappingURL=10.cff43ca9593a0fa0efc1.hot-update.js.map